							...
							{accomoddations.map((accomoddation) => {
								return (
									...
									<Col sm={12} md={6} lg={4} key={accomoddation.id}>
										<Card >
											<Card.Img variant="top" src={accomoddation.image_url} />
											<Card.Body>
												<Card.Title>
													<h5>{accomoddation.name}</h5>
												</Card.Title>
												<Link to={`/admin/accommodation/edit/${accomoddation.id}`} className="accommodation--button" ><Button variant="primary"><i className="fas fa-edit"></i>Edit</Button></Link>
											</Card.Body>
										</Card>
									</Col>
